...
\cvitem{27 horas}{Exposiciones ambientales y cáncer: evidencia epidemiológica - Universidad de Chile}
\cvitem{27 horas}{Epidemiología básica para instituciones de salud - Universidad de Chile}
\cvitem{24 horas}{Capacitación en Estimación y Monitoreo de Precipitación por Radar - IGP/PUCP}
...
\section{Cursos como expositor}

\cvitem{28 horas}{Capacitación en software R - SENAMHI}
\cvitem{16 horas}{R aplicado a la hidrología - Andes Engineers and Projects}